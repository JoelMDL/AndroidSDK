...
public class BatteryListener extends Service {
    ...
    private void updateWidget(Context context, int appWidgetId, int batteryLevel, boolean isCharging) {
        ...
        if (isCharging) {
            views.setViewVisibility(R.id.phoneIco, View.VISIBLE); // Hide phone icon
            views.setViewVisibility(R.id.chargeIcon, View.VISIBLE); // Show charging icon
            views.setTextViewText(R.id.batteryPercentage, ""); // Clear the text
        } else {
            views.setViewVisibility(R.id.phoneIco, View.VISIBLE); // Show phone icon
            views.setViewVisibility(R.id.chargeIcon, View.GONE); // Hide charging icon
